                                  ...
                                  <div class="col-sm-12 col-sm-offset-0">
				                    <form id="contacto" class="form-horizontal" method="POST" action="${contextpath}/equivira">
				                        ...
				                        <div class="form-group">
				                            ...
				                            <div class="col-md-9">
				                                <input type="text" class="text form-control" id="correoContacto" name="correoContacto" placeholder="Escriba su correo...">
				                            </div>
				                        </div>
				                        <div class="form-group">
				                        	<span class="col-md-1 col-md-offset-1 text-center"><i class="fa fa-pencil-square-o bigicon"></i></span>
				                            <div class="col-sm-9">
				                                <textarea class="form-control" id="mensajeContacto" name="mensajeContacto" placeholder="Escriba su mensaje..." rows="7" style="resize:none"></textarea>
				                            </div>
				                        </div>
				                    </form>
				                </div>

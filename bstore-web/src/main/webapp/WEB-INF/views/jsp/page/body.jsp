    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12 col-sm-offset-0 col-md-10 col-md-offset-1 main">
          <div id="contenidoDinamico"><jsp:include page="../page/listaCoros.jsp"></jsp:include></div>
          <div id="contactoJSP"><jsp:include page="../page/contacto.jsp"></jsp:include></div>
          <div id="agregarCoroJSP"><jsp:include page="../page/agregarCoro.jsp"></jsp:include></div>
          <div id="perfilJSP"><jsp:include page="../page/perfil.jsp"></jsp:include></div>
          <div id="avisoJSP"><jsp:include page="../page/aviso.jsp"></jsp:include></div>

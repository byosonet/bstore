...
<c:set var="urlhref"><spring:message code="url.menu.href"/></c:set>
    ...
    <body>
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-right top-nav">
                	<li class="dropdown">
                        <a class="text" href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: white;"><span class="text"> </span> <i class=""></i> Sobre nosotros <b class="caret"></b></a>
                        <ul class="dropdown-menu" style="min-width:180px">
                            <li>
                                <a class="text" href="http://www.edicionesquivira.com/novohispanorum.html" target="_blank">Novohispanorum</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                            	<a href="#" class="text" data-toggle="modal" data-target="#modalTerminosCondicionesInterno">T&eacute;rminos y condiciones</a>
                                <!-- a class="text" href="#">T&eacute;rminos y condiciones</a -->
                            </li>
                            <li class="divider"></li>
                            <li>
                            	<a href="#" class="text" data-toggle="modal" data-target="#modalAvisoPrivacidadInterno">Aviso de privacidad</a>
                                <!-- a class="text" href="#">Aviso de privacidad</a -->
                            </li>
                            <!-- li class="divider"></li>
                            <li>
                            	<a href="#" class="text" data-toggle="modal" data-target="#modalContactoInterno">Contacto</a>
                            </li -->
                        </ul>
                    </li>
                </ul>
        ...
        <form id="index"></form>
            ...
            <!-- Inician dialogos -->
            <div class="container">
			  <div class="modal fade" id="modalTerminosCondicionesInterno" role="dialog">
              ...
              <div class="modal fade" id="modalAvisoPrivacidadInterno" role="dialog">
                  <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                          <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
              ...
              <div class="modal fade" id="modalContactoInterno" role="dialog">
                  <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                          <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>

...
/**
 * UsuarioPuesto generated by hbm2java
 */
public class UsuarioPuesto implements java.io.Serializable {
	...
	public UsuarioPuesto(Usuario usuario, int estatus, String nombre, Date fechaUmodif) {
	...
	public UsuarioPuesto(Usuario usuario, int estatus, String nombre, Date fechaUmodif, Set<UsuarioInfo> usuarioInfos) {
		this.usuario = usuario;
		this.estatus = estatus;
		this.nombre = nombre;
		this.fechaUmodif = fechaUmodif;

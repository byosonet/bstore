...
public class Editorial implements java.io.Serializable {
	...
	public Editorial(int id, Direccion direccion, Usuario usuario, int estatus, String nombre, Date fechaUmodif) {
		this.id = id;
	...
	public Editorial(int id, Direccion direccion, Usuario usuario, String email, int estatus, String nombre, String rfc,
			String telefono, Date fechaUmodif, Set<Publicacion> publicacions) {
		this.id = id;
		this.direccion = direccion;
		this.usuario = usuario;
		this.email = email;
